...
var G__11991 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11991,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11991;
}
});
...
var or__8936__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__10215__auto___11996 = arguments.length;
var i__10216__auto___11997 = (0);
while(true){
if((i__10216__auto___11997 < len__10215__auto___11996)){
args__10222__auto__.push((arguments[i__10216__auto___11997]));

var G__11998 = (i__10216__auto___11997 + (1));
i__10216__auto___11997 = G__11998;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__10223__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11993){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__11994,G__11995,seq11993__$2);
});
...
var column = cljs.core.get.call(null,map__12000__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12000,map__12000__$1,file,line,column){
return (function (p1__11999_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11999_SHARP_));
});})(map__12000,map__12000__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__9991__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__9991__auto__,prefer_table__9992__auto__,method_cache__9993__auto__,cached_hierarchy__9994__auto__,hierarchy__9995__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__8936__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__8936__auto__)){
return or__8936__auto__;
} else {
...
var temp__5457__auto___12002 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12002)){
var message_12003 = temp__5457__auto___12002;
cljs.core.println.call(null,message_12003);
} else {
}
...
var temp__5457__auto___12004 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12004)){
var message_12005 = temp__5457__auto___12004;
cljs.core.println.call(null,message_12005);
} else {
}
...
var output_dir__$1 = (function (){var G__12006 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12006),"/"].join('');
} else {
return G__12006;
}
})();
...
var temp__5455__auto__ = (function (){var and__8924__auto__ = typeof exception.stack === 'string';
if(and__8924__auto__){
var G__12008 = exception.stack;
var G__12008__$1 = (((G__12008 == null))?null:clojure.string.split_lines.call(null,G__12008));
var G__12008__$2 = (((G__12008__$1 == null))?null:cljs.core.get.call(null,G__12008__$1,depth));
if((G__12008__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12008__$2);
}
} else {
...
var vec__12009 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12009,(0),null);
var column = cljs.core.nth.call(null,vec__12009,(1),null);
var vec__12012 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12012,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12012,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12012,(2),null);
...
var m__$1 = (function (){var G__12015 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12019 = (function (){var G__12018 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12018);
} else {
return G__12018;
}
})();
...
return cljs.core.vary_meta.call(null,G__12020,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12024 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12024,(0),null);
var types = vec__12024;
...
return cljs.core.map.call(null,(function (p__12027){
var vec__12028 = p__12027;
var ns = cljs.core.nth.call(null,vec__12028,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12028,(1),null);
return ((function (vec__12028,ns,vars__$1){
return (function (){
...
var G__12031 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1){
return (function (){
var seq__12032 = cljs.core.seq.call(null,vars__$1);
var chunk__12033 = null;
var count__12034 = (0);
var i__12035 = (0);
while(true){
if((i__12035 < count__12034)){
var v = cljs.core._nth.call(null,chunk__12033,i__12035);
var temp__5457__auto___12037 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12037)){
var t_12038 = temp__5457__auto___12037;
each_fixture_fn.call(null,((function (seq__12032,chunk__12033,count__12034,i__12035,t_12038,temp__5457__auto___12037,v,each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12038)));
});})(seq__12032,chunk__12033,count__12034,i__12035,t_12038,temp__5457__auto___12037,v,each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1))
);
} else {
}

var G__12039 = seq__12032;
var G__12040 = chunk__12033;
var G__12041 = count__12034;
var G__12042 = (i__12035 + (1));
seq__12032 = G__12039;
chunk__12033 = G__12040;
count__12034 = G__12041;
i__12035 = G__12042;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__12032);
if(temp__5457__auto__){
var seq__12032__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12032__$1)){
var c__9867__auto__ = cljs.core.chunk_first.call(null,seq__12032__$1);
var G__12043 = cljs.core.chunk_rest.call(null,seq__12032__$1);
var G__12044 = c__9867__auto__;
var G__12045 = cljs.core.count.call(null,c__9867__auto__);
var G__12046 = (0);
seq__12032 = G__12043;
chunk__12033 = G__12044;
count__12034 = G__12045;
i__12035 = G__12046;
continue;
} else {
var v = cljs.core.first.call(null,seq__12032__$1);
var temp__5457__auto___12047__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12047__$1)){
var t_12048 = temp__5457__auto___12047__$1;
each_fixture_fn.call(null,((function (seq__12032,chunk__12033,count__12034,i__12035,t_12048,temp__5457__auto___12047__$1,v,seq__12032__$1,temp__5457__auto__,each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12048)));
});})(seq__12032,chunk__12033,count__12034,i__12035,t_12048,temp__5457__auto___12047__$1,v,seq__12032__$1,temp__5457__auto__,each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1))
);
} else {
}

var G__12049 = cljs.core.next.call(null,seq__12032__$1);
var G__12050 = null;
var G__12051 = (0);
var G__12052 = (0);
seq__12032 = G__12049;
chunk__12033 = G__12050;
count__12034 = G__12051;
i__12035 = G__12052;
continue;
}
} else {
...
});})(each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1))
);
});})(each_fixture_fn,G__12031,G__12031__$1,env,once_fixtures,each_fixtures,vec__12028,ns,vars__$1))
], null);
